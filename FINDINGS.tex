...
as ReLU activation function on the model. We dicuss the linear findings in section
...
similar methods to train a set of linear models but this is descussed seperately
in section [insert].\\
...
this is no case where the one-neuron models should "want" to have a very high bias.
...
with unconventional standard deviation is not to eliminate the need for training
...
the original authors of \textit{Toy Models of Superposition} in 
