...
The overall result of this training is shown below compared with the findings
...
each illustrate
analogous overall trends. When the second output has a very low level of relative feature
importance and overall feature density is high, the one-neuron ReLU models tend to represent
...
the point was colored purple. Using this mehtod may have been more strict than
...
and empirical findings may have been the non-ideal environment the
