...
\begin{quote}
    ...
    paper focuses on making overservations and replicating the most important 
    results from the  introduction and sections 1, 2, and 3 of the original 
    paper. This document may be expanded to include more examples or other 
