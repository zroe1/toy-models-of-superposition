...
defined by $W^TWx + b$ and the ReLU model was defined by ReLU($W^TWx + b$). Both 
...
Figure~\ref{fig:sparsity_1}, it will be useful to dive a the math behind the
concept of feature interference. The extent to which features interfere with
eachother is defined by the following equation:
